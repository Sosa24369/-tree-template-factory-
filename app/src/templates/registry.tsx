...
import { TEMPLATE_META, type TemplateMeta } from './meta';

// Re-exported so every existing import site (entry-server, App, the prerenderer)
// keeps working unchanged; the data itself now lives in ./meta.ts.
